...
<body>
 ...
 <%
		...
		String user = request.getParameter("cRepUsername");
		String pass = request.getParameter("cRepPassword");
		String uType = "R"; 
		...
		if(result.next()){
			...
			<% 
			session.setAttribute("customerRep", user);
			System.out.println(session.getAttribute("customerRep"));
